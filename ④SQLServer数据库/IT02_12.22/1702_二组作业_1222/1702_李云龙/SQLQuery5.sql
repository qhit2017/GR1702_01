...
('李龙','5','员工',5000,2000,'20140102','男'),
 ('张龙','30','员工',8000,9000,'20120102','男'),
 ('李庆','5','总长',5000,7000,'20110102','男'),
 ('刘龙','7','员工',6000,2000,'20140102','男'),
 ('王雪','9','经理',5000,2000,'20140102','女'),
 ('刘雪','2','经理',6000,1000,'20130102','女'),
 ('张雪','9','经理',6000,1000,'20130102','女'),
 ('刘洋','3','经理',6000,1000,'20130102','男'),
 ...
 ('夏杰','10','经理',5500,1500,'20080604','男')
-- 1  选择部门30中的所有员工
 SELECT * FROM tb_emp WHERE daptno ='30'
--2  列出所有办事员（CLERK）的姓名，雇员编号和部门编号。
 SELECT ename as 姓名,empno as 雇员编号,daptno AS 部门编号
  FROM tb_emp
 WHERE job ='办事员'
--3  找出奖金高于薪金的员工。
...
--5  找出部门10中所有经理（MANAGER）和部门20中所有办事员（CLERK）的详细资料。
 SELECT * FROM tb_emp 
 WHERE  daptno ='10'AND job ='经理' OR daptno ='20'AND job ='办事员'
...
SELECT AVG(sal)as 平均薪水,daptno as 部门名  FROM tb_emp group BY daptno
...
SELECT COUNT(daptno) as 员工人数,daptno as 部门名 
 FROM tb_emp group BY daptno 
ORDER BY COUNT(daptno)desc
--15  查询每个部门女员工的人数。
SELECT COUNT(daptno) as 女员工人数,daptno as 部门名
  FROM tb_emp where sex='女' group BY daptno 
--16  显示2007年到2017年之前入职的员工的姓名和受雇日期。
 SELECT ename as 员工的姓名,hiredate as 受雇日期 
 FROM tb_emp
...
--19  显示所有员工的姓名、工作和薪金，按工作的降序排序，若工作相同则按薪金排序。
 SELECT ename as 员工的姓名,job as 工作, sal as 薪金
...
--22  查询每个部门不同职位的平均奖金，平均薪水，部门和职位名。
 SELECT AVG(comm) as 平均奖金,AVG(sal) as 平均薪水,daptno as 部门,job as 职位 
...
SELECT daptno as 部门, ename as 员工的姓名
 FROM tb_emp
  where sal  BETWEEN 900 AND 3000
--28  查询每个职位的最低工资，并按照工资进行升学排序。
SELECT job as 职位,MIN(sal) as 最低工资
