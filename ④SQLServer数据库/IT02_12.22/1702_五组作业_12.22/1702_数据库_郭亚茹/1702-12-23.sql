...
INSERT INTO tb_company VALUES 
							  (001,'李小豪','人事部','办事员',6000,500,'2014-11-20','boy'),
							  (002,'于和璧','研发部','经理',9000,9500,'2013-1-19','boy'),
                              (003,'孙寒','人事部','办事员',6000,500,'2014-5-21','boy'),
                              (004,'王迎阔','销售部','经理',7000,1500,'2007-6-27','boy'),
                              (005,'郑光达','研发部','办事员',8000,600,'2017-12-25','boy'),
                              (006,'Arry','30','办事员',6000,500,'2005-11-24','girl'),
                              (007,'曾祥顺','财务部','会计',6000,900,'2006-8-20','boy'),
                              (008,'李静静','10','办事员',6000,1500,'2014-11-22','girl'),
                              (009,'李少庆','20','办事员',2200,800,'2014-8-20','boy'),
                              (010,'rose','30','办事员',3300,900,'2014-5-20','girl'),
                              (011,'杨雪婷','销售部','办事员',6000,700,'2004-11-2','girl'),
                              (012,'lily','销售部','办事员',6000,800,'2014-11-20','girl'),
                              (013,'孔于辉','研发部','委员',3300,300,'2004-5-21','boy'),
                              (014,'王帅杰','研发部','办事员',6000,500,'2014-11-20','boy'),
                              (015,'mike','研发部','办事员',6600,600,'2014-11-20','boy'),
                              (016,'盛名春','生产技术部','办事员',8800,500,'2014-11-20','boy'),
                              (017,'古国鑫','10','经理',4400,500,'2012-11-20','boy'),
                              (019,'John','人事部','办事员',5500,500,'2014-11-20','boy'),
                              (019,'John','生产技术部','办事员',7000,500,'2014-11-20','boy'),
                              (018,'刘宇衡','人事部','办事员',6000,500,'2014-11-20','boy'),
                              (019,'John','人事部','办事员',9000,100,'2014-11-20','boy'),
                              (019,'梁营营','20','办事员',8000,300,'2015-11-20','girl'),
                              (020,'赵舞阳','人事部','办事员',4000,700,'2017-11-20','boy'),
                              (021,'Johnaon ','安全监察部','委员',3000,500,'2014-11-20','boy'),
                              (022,'李永利','人事部','办事员',6000,500,'2014-11-20','boy'),
                              (023,'Maria','安全监察部','办事员',7000,500,'2014-11-20','girl'),
                              (024,'刘天伟','人事部','委员',6000,500,'2014-11-20','boy'),
                              (025,'夏杰','安全监察部','办事员',6000,500,'2013-11-20','boy'),
                              (026,'mary','安全监察部','办事员',7000,1100,'2012-11-20','girl'),
                              (027,'Jason','生产技术部','办事员',7000,0,'2014-11-20','boy'),
                              (028,'王欣','人事部','办事员',9000,500,'2015-11-20','girl'),
                              (029,'徐云梦','生产技术部','办事员',8000,700,'2016-11-20','girl'),
                              (030,'李云龙','人事部','办事员',6000,500,'2017-11-21','boy'),
                              (031,'guo','人事部','办事员',3000,6000,'2017-11-11','boy'),
                              (001,'李小豪','人事部','办事员',6000,500,'2014-11-20','boy')
                             select * FROM  tb_company
----1  选择部门30中的所有员工。
...
----3  找出奖金高于薪金的员工。
SELECT ename as 姓名  from tb_company where comm >sal 
----4  找出奖金高于薪金60%的员工。
 SELECT ename as姓名 from  tb_company where comm >sal*(1+0.6)
...
----8  找出没有奖金或奖金低于100的员工。
select ename as 姓名 from tb_company where comm is null or comm <100
...
----10  找出早于2012年前受雇的员工。
select ename as姓名 ,hiredate as受雇的员工 from tb_company where hiredate < '2012'
----11 查询公司员工薪水总数
select  sum(sal) from tb_company  
----12  显示正好为5个字符的员工的姓名。   
SELECT ename as姓名 from tb_company where ename like '_____%' and len(ename) = 5
---- 13  显示不带有'R'的员工的姓名。
select  ename as姓名 from tb_company where ename NOT LIKE'%R%'
----14  查询每个部门员工人数和部门名，并按照员工人数进行降序排序。
select COUNT (deptno)as 员工人数,deptno as 部门 from tb_company group  by  deptno order by count (deptno) desc
----15  查询每个部门女员工的人数。  
